...
Homeworks problems for week 2

## 1. Read Sud et al and complete the self assessment quiz (10 points)
[SUD comprehension assessment quiz](new link here). Feel free to use multiple attempts.

## 2. Complete the [Lecture 3-4 assessment quiz](https://forms.gle/KsyP7b5RYFsaAXFW6) 

## 3.  Multiple testing simulation (20 points)
